...
/*
Train is a stock (TrainType) running on a track at a certain speed and to which
...
/*
setSimulation sets the Simulation this Train is part of and initializes TrainHead.
*/
...
/*
TrainType returns a pointer to the TrainType this Train is running.
*/
