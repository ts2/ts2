...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle(tr("ts2 - Train Signalling Simulation"))
        
        # Simulation
        self.simulation = Simulation()
        
        # Actions
        self.openAction = QAction(tr("&Open..."), self)
        self.openAction.setShortcut(QKeySequence.Open)
        self.openAction.setToolTip(tr("Open a simulation"))
        self.openAction.triggered.connect(self.loadSimulation)
        
        self.quitAction = QAction(tr("&Quit"), self)
        self.quitAction.setShortcut(QKeySequence(tr("Ctrl+Q")))
        self.quitAction.setToolTip(tr("Quit TS2"))
        self.quitAction.triggered.connect(self.close)

        self.aboutAction = QAction(tr("&About TS2..."), self)
        self.aboutAction.setToolTip(tr("About TS2"))
        self.aboutAction.triggered.connect(self.showAboutBox)

        self.aboutQtAction = QAction(tr("About Qt..."), self)
        self.aboutQtAction.setToolTip(tr("About Qt"))
        self.aboutQt.triggered.connect(self.aboutQt)

        # Menu
        self.fileMenu = self.menuBar.addMenu(tr("&File"))
        self.fileMenu.addAction(self.openAction)
        self.fileMenu.addSeparator()
        self.fileMenu.addAction(self.quitAction)
        self.helpMenu = self.menuBar.addMenu(tr("&Help"))
        self.helpMenu.addAction(self.aboutAction)
        self.helpMenu.addAction(self.aboutQtAction)
        self.menuBar.setCursor(Qt.PointingHandCursor)
        
        # Dock Widgets
        self.trainInfoPanel = QDockWidget(tr("Train Information"), self)
        ...
        self._trainInfoView.setModel(Train.selectedTrainModel)
        ...
        self.serviceInfoPanel = QDockWidget(tr("Service Information"), self)
        ...
        self._serviceInfoView.setModel(Service.selectedServiceModel)
        self.serviceInfoPanel.setWidget(self._serviceInfoView)
        self.addDockWidget(Qt.RightDockWidgetArea, self.serviceInfoPanel)

        self.placeInfoPanel = QDockWidget(tr("Station Information"), self)
        ...
        # Panel
        self.panel = Panel(self.board);
        self.simultation.timeChanged.triggered.connect(self.panel.clock.setTime)
    ...
    @pyqtProperty(TrainListView)
    def trainListView(self):
        return self._trainListView

    @pyqtProperty(QGraphicsView)
    def view(self):
        return self._view
